[
  ...
  },
  {
    ...
    "data": {
      ...
      "description": "<p>This XML is straight from the server to a \"preset\" file. No modifications were made to the xml at all. There were 5 images. Image 5 was used in the second slide (which was layout 7). The other four were used in multi-image layout 16. Images 1, 2, and 4 had captions, I left #3 blank. User text was entered on the first two slides.</p><p>Strangely, some of the captions and text input were converted to dates. This happened BEFORE I got the XML, so it is acually reflected there.</p>"
    }
  }
]